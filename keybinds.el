...
(global-set-key
 [f2]
 (lambda () (interactive)
   (find-file "~/Code/Cognician/Base/deps.edn")))
(global-set-key
 [f3]
 (lambda () (interactive)
   (find-file "~/Code/Cognician/Tock/deps.edn")))
(global-set-key
 [M-f2]
 (lambda () (interactive)
   (find-file "~/Code/Cognician/ReportQueue/deps.edn")))
(global-set-key
 [M-f3]
 (lambda () (interactive)
   (find-file "~/Code/Cognician/Chat/deps.edn")))
(global-set-key
 [f12]
 (lambda () (interactive)
